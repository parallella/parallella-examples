...
proc create_root_design { parentCell } {
  ...
  set CSI_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 CSI_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {32} CONFIG.DATA_WIDTH {32} CONFIG.NUM_READ_OUTSTANDING {2} CONFIG.NUM_WRITE_OUTSTANDING {2} CONFIG.PROTOCOL {AXI4LITE}  ] $CSI_AXI
  set CSI_VIDEO [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 CSI_VIDEO ]
  set_property -dict [ list CONFIG.HAS_TKEEP {1} CONFIG.HAS_TLAST {1} CONFIG.HAS_TREADY {1} CONFIG.HAS_TSTRB {0} CONFIG.LAYERED_METADATA {undef} CONFIG.PHASE {0.000} CONFIG.TDATA_NUM_BYTES {4} CONFIG.TDEST_WIDTH {0} CONFIG.TID_WIDTH {0} CONFIG.TUSER_WIDTH {1}  ] $CSI_VIDEO
  ...
  # Create ports
  set CAM_I2C_SCL [ create_bd_port -dir IO CAM_I2C_SCL ]
  set CAM_I2C_SDA [ create_bd_port -dir IO CAM_I2C_SDA ]
  ...
  set_property -dict [ list CONFIG.ASSOCIATED_BUSIF {CSI_VIDEO:CSI_AXI}  ] $FCLK_CLK0
  set FCLK_CLK1 [ create_bd_port -dir O -type clk FCLK_CLK1 ]
  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $FCLK_CLK1
  ...
  set csi_intr [ create_bd_port -dir I -type intr csi_intr ]

  # Create instance: axi_lite_0, and set properties
  set axi_lite_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_lite_0 ]
  set_property -dict [ list CONFIG.NUM_MI {3}  ] $axi_lite_0
  ...
  set_property -dict [ list CONFIG.DATA_WIDTH {64} CONFIG.TRANSLATION_MODE {2}  ] $axi_protocol_converter_1
  ...
  set_property -dict [ list CONFIG.c_include_mm2s {0} CONFIG.c_m_axi_s2mm_data_width {64} CONFIG.c_num_fstores {4} CONFIG.c_s2mm_max_burst_length {32}  ] $axi_vdma_0
  ...
  # Create instance: parallella_i2c_1, and set properties
  set parallella_i2c_1 [ create_bd_cell -type ip -vlnv adapteva.com:Adapteva:parallella_i2c:1.0 parallella_i2c_1 ]
...
CONFIG.PCW_UIPARAM_DDR_DRAM_WIDTH {32 Bits} CONFIG.PCW_UIPARAM_DDR_FREQ_MHZ {533.33} \
...
CONFIG.PCW_UIPARAM_DDR_TRAIN_WRITE_LEVEL {1} CONFIG.PCW_UIPARAM_DDR_T_FAW {40} \
CONFIG.PCW_UIPARAM_DDR_T_RAS_MIN {35} CONFIG.PCW_UIPARAM_DDR_T_RC {48.75} \
...
CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.PCW_USE_S_AXI_HP1 {1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net CSI_VIDEO_1 [get_bd_intf_ports CSI_VIDEO] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_lite_0_M00_AXI [get_bd_intf_pins axi_lite_0/M00_AXI] [get_bd_intf_pins elink2/S_AXI_CFG]
  connect_bd_intf_net -intf_net axi_lite_0_M01_AXI [get_bd_intf_pins axi_lite_0/M01_AXI] [get_bd_intf_pins axi_vdma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_lite_0_M02_AXI [get_bd_intf_ports CSI_AXI] [get_bd_intf_pins axi_lite_0/M02_AXI]
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXI_S2MM [get_bd_intf_pins axi_protocol_converter_1/S_AXI] [get_bd_intf_pins axi_vdma_0/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_1 [get_bd_intf_pins parallella_i2c_1/I2C] [get_bd_intf_pins processing_system7_0/IIC_1]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins axi_lite_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  ...
  connect_bd_net -net Net4 [get_bd_ports CAM_I2C_SDA] [get_bd_pins parallella_i2c_1/I2C_SDA]
  connect_bd_net -net Net5 [get_bd_ports CAM_I2C_SCL] [get_bd_pins parallella_i2c_1/I2C_SCL]
  connect_bd_net -net axi_vdma_0_s2mm_introut [get_bd_pins axi_vdma_0/s2mm_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net csi_intr_1 [get_bd_ports csi_intr] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_ports aresetn] [get_bd_pins axi_lite_0/ARESETN] [get_bd_pins axi_lite_0/M00_ARESETN] [get_bd_pins axi_lite_0/M01_ARESETN] [get_bd_pins axi_lite_0/M02_ARESETN] [get_bd_pins axi_lite_0/S00_ARESETN] [get_bd_pins axi_protocol_converter_0/aresetn] [get_bd_pins axi_protocol_converter_1/aresetn] [get_bd_pins axi_protocol_converter_2/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins elink2/m00_axi_aresetn] [get_bd_pins elink2/s00_axi_aresetn] [get_bd_pins elink2/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports FCLK_CLK0] [get_bd_pins axi_lite_0/ACLK] [get_bd_pins axi_lite_0/M00_ACLK] [get_bd_pins axi_lite_0/M01_ACLK] [get_bd_pins axi_lite_0/M02_ACLK] [get_bd_pins axi_lite_0/S00_ACLK] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins axi_protocol_converter_1/aclk] [get_bd_pins axi_protocol_converter_2/aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins elink2/clkin] [get_bd_pins elink2/m00_axi_aclk] [get_bd_pins elink2/s00_axi_aclk] [get_bd_pins elink2/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs CSI_AXI/Reg] SEG_CSI_AXI_Reg
